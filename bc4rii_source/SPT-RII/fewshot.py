...
parser.add_argument("--model", type=str, default='bert') # bert
parser.add_argument("--model_name_or_path", default='/home/zy-4090-1/hqq/SPT-RII/model/chinese-roberta-wwm-ext')#bert分词器
